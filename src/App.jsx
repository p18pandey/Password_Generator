...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-lg mx-auto shadow-md rounded-lg px-9 py-4 my-8 
      text-orange-500 bg-gray-700'>
        <h1 className='text-white text-2xl text-center py-3 underline my-3'>Password Generator</h1>
